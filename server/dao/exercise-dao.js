...
class ExerciseDao {
  ...
  async addExercise(exercise) {
    ...
    let update_exercise_data = {}
    for (let key in exercise_parameters) {
      if (!(key in exercise)) {update_exercise_data[key] = exercise_parameters[key];}
    }
    exercise = {...exercise, ...update_exercise_data}
